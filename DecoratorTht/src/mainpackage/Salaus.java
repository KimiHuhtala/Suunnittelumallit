...
public class Salaus extends SalauksenKäsittelijä {
    public Salaus(ITiedostonKäsittelijä handlerToBeDecorated) {
    ...
    public void write(String message){
        try {
            ...
            writer.close();
            System.out.println("Onnistuneesti lisättiin salattu teksti tiedostoon.");
        } catch (IOException e) {
    ...
    public String getDescription(){
        return super.getDescription() + ", salattu";
    }
}
